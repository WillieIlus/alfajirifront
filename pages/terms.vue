                    ...
                    <div class="md:w-3/4">
                        <div class="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                            ...
                            <ul class="list-unstyled text-slate-400 mt-4">
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-emerald-600 align-middle me-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-emerald-600 align-middle me-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-emerald-600 align-middle me-2"></i>Create your own skin to match your brand</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-emerald-600 align-middle me-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-emerald-600 align-middle me-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-emerald-600 align-middle me-2"></i>Create your own skin to match your brand</li>
                            </ul>
                            ...
                            <div class="mt-8">
                                <a href="" class="btn bg-emerald-600 hover:bg-emerald-700 text-white rounded-md">Print</a>
                            </div>
                        </div>
                    </div><!--end -->
                </div><!--end grid-->
